...
public class HandResourceIT {
    ...
    private static final BigDecimal DEFAULT_WINNING_CHIPS = new BigDecimal(1);
    private static final BigDecimal UPDATED_WINNING_CHIPS = new BigDecimal(2);
    ...
    public static Hand createEntity(EntityManager em) {
        Hand hand = new Hand()
            ...
            .winningChips(DEFAULT_WINNING_CHIPS);
        return hand;
    }
    /**
    ...
    public static Hand createUpdatedEntity(EntityManager em) {
        Hand hand = new Hand()
            ...
            .winningChips(UPDATED_WINNING_CHIPS);
        return hand;
    }
    ...
    public void createHand() throws Exception {
        ...
        assertThat(testHand.getWinningChips()).isEqualTo(DEFAULT_WINNING_CHIPS);
    }
    ...
    public void getAllHands() throws Exception {
        ...
        restHandMockMvc.perform(get("/api/hands?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].winningChips").value(hasItem(DEFAULT_WINNING_CHIPS.intValue())));
    }
    ...
    public void getHand() throws Exception {
        ...
        restHandMockMvc.perform(get("/api/hands/{id}", hand.getId()))
            ...
            .andExpect(jsonPath("$.winningChips").value(DEFAULT_WINNING_CHIPS.intValue()));
    }
    ...
    public void updateHand() throws Exception {
        ...
        assertThat(testHand.getWinningChips()).isEqualTo(UPDATED_WINNING_CHIPS);
    }
