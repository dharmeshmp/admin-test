...
describe('Service Tests', () => {
  describe('Bet Service', () => {
    ...
    let expectedResult: IBet | IBet[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Bet(0, 0, BetStatus.Start);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Bet', () => {
        ...
        service.create(new Bet()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Bet', () => {
        const returnedFromService = Object.assign(
          {
            chips: 1,
            status: 'BBBBBB'
